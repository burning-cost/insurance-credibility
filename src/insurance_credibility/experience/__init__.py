...
Four progressive model tiers for updating a priori GLM premiums with
claims history:
...
def __getattr__(name: str):
    ...
    raise AttributeError(f"module 'insurance_credibility.experience' has no attribute {name!r}")
